...
<html lang="zxx" class="no-js">
  ...
  <body>
      ...
      <div class="container">
        ...
        >
          <div class="banner-content col-lg-7 col-md-6">
            ...
            <a href="index.html#" class="primary-btn text-uppercase"
              >Rent Car Now</a
            >
          </div>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-6 no-padding home-about-left">
            <img
              class="img-fluid"
              src="img/xabout-img.jpg.pagespeed.ic.1_NA9inBJX.jpg"
              alt=""
              data-pagespeed-url-hash="3207731484"
              onload="pagespeed.CriticalImages.checkImageForCriticality(this);"
            />
          </div>
          <div class="col-lg-6 no-padding home-about-right">
            ...
            <a class="text-uppercase primary-btn" href="index.html#"
              >get details</a
            >
          </div>
        </div>
    ...
    <section class="model-area section-gap" id="cars">
      <div class="container">
        <div class="row">
          <div class="pb-40 text-center header-text">
